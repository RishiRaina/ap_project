...
public class InstructorChangePasswordUI extends JPanel {
    ...
    public InstructorChangePasswordUI(MainFrame root) {
        this.root = root;
        ...
        backBtn.addActionListener(e -> root.showScreen(MainFrame.INSTRUCTOR_DASH));
